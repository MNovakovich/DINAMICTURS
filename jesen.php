...
?>
    ...
    <section id="central">
        ...
        <!-- oVDE TREBA DA DODJE NASLOV -->
            ...
            echo"<h1>Krstarenja</h1>";
             
             ?>
                  <div class="col-md-9 col-sm-8 col-xs-8">
          <?php
      
        $hotelLista = Hotel::direct_sql("SELECT hotel.id, hotel.hotel_naziv, hotel.hitCena, hotel.tekst_naslovna, hotel.foto_1 FROM `hotel` 
                                          inner JOIN ponuda
                                          on hotel.ponuda_id = ponuda.id
                                          inner JOIN aranzman
                                          on aranzman.id = ponuda.aranzman_id
                                          where aranzman.id = 3 order BY hotel.id DESC");
                       ...
                       <article class="article hoteliLista">
                          ...
                          <div class="tekstHoteli">  
                            <header>
                              ...
                              <h2><a  href="hotel.php?hotel_id=9" ><?=$value->hotel_naziv;?></a></h2>
