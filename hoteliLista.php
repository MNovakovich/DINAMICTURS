...
require_once "config.php";
  ...
  $ponuda_id = ($_GET['ponuda_id']);
      
if (!isset($ponuda_id) && !number_format($ponuda_id))
   {  
...
?>
    ...
    <section id="central">
        ...
        <!-- oVDE TREBA DA DODJE NASLOV -->
            ...
            $naslov = Ponuda::get("id = $ponuda_id");
        ...
        $hotelLista = Hotel::direct_sql("SELECT * FROM hotel WHERE ponuda_id = $ponuda_id");
